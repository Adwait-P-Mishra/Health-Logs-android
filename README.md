...
## Screenshots
Place your screenshots in `app/src/main/assets/screenshots/` and reference them from the README using the paths below.

- Image 1 — Add Meal: `app/src/main/assets/screenshots/01_add_meal.png`  
...
- Image 2 — Add Exercise: `app/src/main/assets/screenshots/02_add_exercise.png`  
  Shows the Add Exercise form: exercise name, previous session reference, sets (lbs & reps), and notes.

- Image 3 — Meals daily view: `app/src/main/assets/screenshots/03_meals_view.png`  
  Daily meal card listing with calories and macro chips (edit/delete icons present).

- Image 4 — Workouts daily view: `app/src/main/assets/screenshots/04_workouts_view.png`  
  Daily workout cards listing sets (weight × reps) and actions.

- Image 5 — Dashboard: `app/src/main/assets/screenshots/05_dashboard.png`  
  The Dashboard with date picker, quick search, Today's Workouts, and Nutrition Tracker summary.

- Image 6 — Meal History (Poha History): `app/src/main/assets/screenshots/06_meal_history.png`  
  Historical list of a specific meal across dates with macro chips and edit/delete actions.

- Image 7 — Settings / Navigation Drawer: `app/src/main/assets/screenshots/07_settings_menu.png`  
